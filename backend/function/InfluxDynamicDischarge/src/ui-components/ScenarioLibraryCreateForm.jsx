...
export default function ScenarioLibraryCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ScenarioLibrary(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ScenarioLibraryCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
